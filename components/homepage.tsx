  ...
  zh: {
    ...
    investigation: {
      ...
      steps: [
        ...
        {
          title: "推荐可执行行动",
          text: "蝴蝶效应输出了 3 个行动建议，并附带负责人、预期提升和置信度。"
        }
      ]
    },
    reports: {
      eyebrow: "报告",
      title: "自动生成每周增长简报。",
      intro: "从智能调查自动生成摘要、负责人进展和影响追踪，不再手工拼报表。",
      cards: [
        ["增长简报", "本周发生了什么、为什么发生、下一步该关注哪里。"],
        ["影响台账", "统一追踪行动、负责人、置信度和 ARR 变化。"],
        ["管理层摘要", "把原始指标转化为适合复盘和汇报的清晰解释。"]
      ]
    },
    integrations: {
      eyebrow: "支持的数据集成",
