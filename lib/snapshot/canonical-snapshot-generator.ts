...
function canonicalColumns(tableName: string) {
  ...
  const tableFields: Record<string, string[]> = {
    ...
    ecommerce_order_items: ["source_order_id", "source_line_item_id", "order_id", "order_item_id", "product_id", "variant_id", "asin", "sku", "product_name", "title", "product_type", "category", "category_name", "category_full_name", "brand", "vendor", "tags", "handle", "quantity", "unit_price", "gross_sales", "discount_amount", "refund_amount", "net_sales", "cogs", "product_cost", "shipping_cost", "fulfillment_cost", "warehouse_cost", "platform_fee", "payment_fee", "currency", "fulfillment_status"],
    ecommerce_products: [
      "source_product_id",
      "source_variant_id",
      "product_id",
    ...
    ecommerce_ads: ["sku", "campaign_id", "adset_id", "ad_id", "spend", "impressions", "clicks", "conversions", "attribution_revenue", "event_date", "date"],
    ecommerce_inventory: ["sku", "product_id", "variant_id", "asin", "warehouse_id", "stock_level", "available_stock", "inventory_quantity", "reserved_stock", "inventory_value", "inventory_unit_cost", "inventory_cost", "reorder_point", "fulfillment_days", "snapshot_date", "date", "currency"]
  };
